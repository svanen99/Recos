// const Update = () => {
//     return (
//         <div className="bg-[#FFF7ED] text-[#4E342E] px-8 py-12 md:px-16 lg:px-24 font-poppins border-4 border-[#FF7043] m-6 rounded-lg shadow-lg">
//             <div className="max-w-4xl mx-auto space-y-8 text-lg leading-relaxed">
//                 <h1 className="text-4xl font-extrabold text-center animate-fade-in-scale text-[#D84315] mb-2">
//                     Update!
//                 </h1>
