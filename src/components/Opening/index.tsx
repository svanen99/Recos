...
const Opening = () => {
    return (
        <>
            <div className="max-w-full mx-auto p-4 sm:p-6 lg:p-10 m-4 sm:m-6 lg:m-10 flex flex-col lg:flex-row justify-between bg-[#004aad]">
                <div className="flex flex-col lg:w-1/2 p-4">
                    <header className="flex flex-col border-b border-[#ff3130] pb-3 mb-3">
                        <h1 className="text-[#ff3130] text-2xl sm:text-3xl font-serif font-bold text-center mb-2 tracking-wide">
                            New Fall Opening Hours 🍂
                        </h1>
                        <p className="text-center text-sm sm:text-md text-[#FEFEFC] italic">We're excited to serve you!</p>
                    </header>
                    
                    <div className="flex flex-col text-center font-serif text-md sm:text-lg">
                        <p className="text-[#ff3130] font-bold border-[#FFD7B5] py-2 sm:py-3">Monday - CLOSED</p>
                        ...
                        <Link href="/menu">
                            <button className="text-[#FEFEFC] m-4 sm:m-8 text-xl sm:text-2xl font-poppins transition-transform duration-300 transform hover:scale-110 bg-[#ff3130] hover:bg-[#ff3130] rounded-lg shadow-lg p-2">
                                Check Out the Menu!
                            </button>
                        </Link>
                    </div>
